...
class Heroes {
    ...
    fun setUpProfile(name: String?, age: Int, height: Int) {
        this.name = name
        this.age = age
        this.height = height
    }
...
fun main() {
    val hero = Heroes()
    hero.setUpProfile("Ary Linggar Palupi", 21, 153)

    // Menampilkan profil sebelum aktivitas
    hero.profiles()
    ...
    // Menampilkan profil setelah aktivitas
    hero.profiles()
}
